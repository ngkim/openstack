...
network_neutron_plugin_ml2_config() {
    echo '
    # ------------------------------------------------------------------------------
    ### network_neutron_plugin_ml2_config($NEUTRON_PLUGIN_OVS_CONF_INI) !!!
    # ------------------------------------------------------------------------------'
...
# physnet_private -> guest vlan trunk network
...
# private/external network 만 매핑, hybrid network는 매핑 불필요
# ex) bridge_mappings = physnet_guest:br-private,physnet_ext:br-ex
bridge_mappings = ${PHY_PRVT_NET}:${LOG_PRVT_BR},${PHY_EXT_NET}:${LOG_EXT_BR}
