...
function ctrl_keystone_install() {   
    ...
    apt-get -y --force-yes install ntp ngrep 
    apt-get -y --force-yes install keystone python-keystone python-keystoneclient        
...
function ctrl_keystone_config() {
    ...
    cp ${KEYSTONE_CONF} ${KEYSTONE_CONF}.org     
