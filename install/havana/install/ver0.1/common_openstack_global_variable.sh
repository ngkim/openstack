...
SERVICE_TOKEN=2fbaa23706722ca64e7e
...
NEUTRON_PLUGIN_OVS_CONF_INI=/etc/neutron/plugins/openvswitch/ovs_neutron_plugin.ini
...
printf "%30s -> %s \n" NEUTRON_PLUGIN_OVS_CONF_INI $NEUTRON_PLUGIN_OVS_CONF_INI
