...
ctrl_keystone_service_endpoint_create() {
    ...
    PUBLIC="http://$CONTROLLER_HOST:5000/v2.0"
    ...
    PUBLIC="http://$CONTROLLER_HOST:8774/v2/\$(tenant_id)s"
    ...
    PUBLIC="http://$CONTROLLER_HOST:8773/services/Cloud"
    ...
    PUBLIC="http://$CONTROLLER_HOST:9292/v2"
    ...
    PUBLIC="http://$CONTROLLER_HOST:8776/v1/%(tenant_id)s"
    ...
    PUBLIC="http://$CONTROLLER_HOST:8776/v2/%(tenant_id)s"
    ...
    PUBLIC="http://$CONTROLLER_HOST:9696"
