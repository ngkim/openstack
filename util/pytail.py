...
Simple example:
    ...
    FileTail.tail('/var/log/all', callback).mainloop()
'''
...
if __name__ == "__main__":
    ...
    def callback(line):
        ...
        url  =  "http://211.224.204.158:18003/log"
        data = {"log": line }
    ...
    # 내가 찾던 답
    file = "/var/log/rsyslog/all_host_openstack.log"
    #tail_simul(file, callback)
    
    FileTail(file, callback).mainloop()
